...
class CPM:
    def __init__(self, ilosc_zdarzen, zdarzenia, ilosc_czynnosci, czynnosci, nazwa_diagramu):
        ...
        create_diagram(events_leading_to, zdarzenia, sciezka_krytyczna, nazwa_diagramu)
